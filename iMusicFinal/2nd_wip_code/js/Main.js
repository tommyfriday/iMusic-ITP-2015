...
// 		feedbackDelay.setFeedback(1);
	...
	var osc1 = new Tone.Oscillator(74, "sine").toMaster();
   	osc1.volume.value = -56;
  	osc1.start();
	...
	panner.connect(feedbackDelay);
  	...
  	var osc2 = new Tone.Oscillator(72, "square").toMaster();
    osc2.volume.value = -56;
    osc2.start();
    osc2.connect(panner);
    ...
    var osc3 = new Tone.Oscillator(70, "square").toMaster();
    osc3.volume.value = -56;
    osc3.start();
    osc3.connect(panner);
            var freqLFO = new Tone.LFO(0.1, 50, 1000);
        freqLFO.type = "sine";
    ...
    var osc4 = new Tone.Oscillator(75, "square").toMaster();
    ...
    var osc5 = new Tone.Oscillator(71, "square").toMaster();
...
// }).toMaster();
	...
	var player0 = new Tone.Player("./samples/violin.mp3")
	.connect(feedbackDelay);
	player0.loop = true;

	var player1 = new Tone.Player("./samples/river.mp3")
		.connect(feedbackDelay);
			player1.loop = true;

	var player2 = new Tone.Player("./samples/shrug.mp3")
		.connect(feedbackDelay);
			player2.loop = true;
...
var animate = function () {
	...
	rotation += ( rotationTarget - rotation ) * 0.05; // 0.1 this number determines rotation speed of video objects

	cameraDummy.position.x = Math.sin( rotation * angle ) * 1500; //1500
	cameraDummy.position.z = Math.cos( rotation * angle ) * 1500; //1500
